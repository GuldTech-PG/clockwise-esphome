...
CONF_BRIGHTNESS="brightness"; CONF_DRIVER="driver"; CONF_CLK_PHASE="clock_phase"
...
ns = cg.esphome_ns.namespace("clockwise_pacman_ext")
PacmanClk = ns.class_("PacmanClock", cg.PollingComponent)

CONFIG_SCHEMA = cv.Schema({
  cv.GenerateID(): cv.declare_id(PacmanClk),
  ...
  cv.Optional(CONF_DRIVER, default="FM6126A"): cv.one_of("FM6126A","DEFAULT"),
